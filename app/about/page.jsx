  ...
  return (
    <div className="py-20 px-4 max-w-6xl mx-auto">
      <h1 className="text-3xl font-bold mb-4 text-slate-800">
        About FAVOUR REALTORS
      </h1>
      <p className="mb-4 text-slate-700">
        <span className="font-bold">Favour Realtors</span> is a leading real
        estate agency that specialized in helping clients buy, sell, and rent
      ...
      <p className="mb-4 text-slate-700">
        ...
        of the local market. Whether you are looking to by, sell, or rent a
        property, we are here to help you every step of the way.
      </p>
      <p className="mb-4 text-slate-700">
        Our team of Agents have a wealth of experience and knowledge in the real
